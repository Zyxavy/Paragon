...
| **Vitest** | API integration tests (D1 + Workers runtime) | `pnpm --filter api test:integration` | 127 tests: smoke (3), recovery (2), auth (3), systems CRUD (16), calendar (32), schedules (12), instances (9), workspace (24), journal (9), reviews (10), templates (7) |
